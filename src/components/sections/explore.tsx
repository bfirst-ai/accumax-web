...
const doors = [
  {
    ...
    body: "Fourteen CoPilots covering the whole engagement — intake, recognize, extract, prepare, review, plan, defend, compose. Tightly integrated with the Practice OS.",
    href: "/copilots",
  ...
  },
  {
    ...
    body: "Client intake through approvals, eSignature, invoicing, payments, dashboards and governance — tightly integrated with the AccuTax CoPilots.",
    href: "/features",
