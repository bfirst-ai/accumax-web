...
const doors = [
  {
    ...
    body: "Fourteen CoPilots covering the whole engagement — intake, recognize, extract, prepare, review, plan, defend, compose. They work inside the Practice OS, not beside it.",
    href: "/copilots",
  ...
  },
  {
    ...
    body: "Client intake through approvals, eSignature, invoicing, payments, dashboards and governance — the system of record the CoPilots do their work in.",
    href: "/features",
